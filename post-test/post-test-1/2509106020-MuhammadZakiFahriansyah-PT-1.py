...
Materi acuan: Modul 1 (Class & Object), Modul 2 (Atribut & Method),
              Modul 3 (Encapsulation & Property)

Program ini mengelola data pasien, ahli gizi, menu diet, dan catatan
kesehatan pada sebuah klinik gizi. Empat class saling berinteraksi
melalui objek (bukan lewat inheritance, karena tidak diwajibkan pada
ketentuan post-test dan belum dibahas pada tiga modul acuan).
"""


class Pasien:
    """Merepresentasikan data seorang pasien pada klinik gizi."""
    ...
    def __init__(self, id_pasien, nama, password, berat_badan, tinggi_badan,
        ...
        # Atribut private (data fisik & medis yang sensitif)
    ...
    def berat_badan(self):
        """Getter berat badan (kg)."""
        return self.__berat_badan

    @berat_badan.setter
    def berat_badan(self, nilai_baru):
        """Setter berat badan dengan validasi harus lebih dari 0."""
        if nilai_baru <= 0:
    ...
    def tinggi_badan(self):
        """Getter tinggi badan (cm)."""
        return self.__tinggi_badan

    @tinggi_badan.setter
    def tinggi_badan(self, nilai_baru):
        """Setter tinggi badan dengan validasi harus lebih dari 0."""
        if nilai_baru <= 0:
    ...
    def verifikasi_password(self, password_input):
        """Mengecek kecocokan password tanpa mengekspos nilai aslinya."""
    ...
    def hitung_kebutuhan_kalori(self):
        ...
        Rumus dasar disederhanakan: 24 x berat badan (kg), lalu dikalikan
        faktor aktivitas yang berbeda sesuai kategori pasien.
        """
    ...
    def tampilkan_profil(self):
        """Menampilkan ringkasan profil pasien."""
    ...
    def dari_dict(cls, data):
        """Factory method: membuat objek Pasien dari data berbentuk dictionary."""
        return cls(
    ...
    def ganti_nama_klinik(cls, nama_baru):
        """Mengubah atribut kelas nama_klinik untuk seluruh objek Pasien."""
        cls.nama_klinik = nama_baru

    # ------------------ Static Method ------------------
    @staticmethod
    def validasi_kategori(kategori):
        """Fungsi bantu untuk mengecek apakah kategori pasien valid."""
        return kategori in Pasien.kategori_valid


class AhliGizi:
    """Merepresentasikan data seorang ahli gizi pada klinik."""
    ...
    def __init__(self, id_ahli, nama, password, spesialisasi, nomor_str):
        ...
        self.__password = password
        self.__nomor_str = nomor_str  # nomor STR, data sensitif
    ...
    @property
    def nomor_str(self):
        """Getter nomor STR (Surat Tanda Registrasi)."""
        return self.__nomor_str

    @nomor_str.setter
    def nomor_str(self, nilai_baru):
        """Setter nomor STR dengan validasi minimal 6 karakter dan tidak kosong."""
    ...
    def buat_rekomendasi(self, pasien, menu):
        """Membuat rekomendasi diet untuk seorang pasien berdasarkan sebuah menu."""
    ...
    @classmethod
    def dari_dict(cls, data):
        """Factory method: membuat objek AhliGizi dari dictionary."""
        return cls(
    ...
    def validasi_spesialisasi(spesialisasi):
        """Fungsi bantu untuk mengecek apakah spesialisasi valid."""
        return spesialisasi in AhliGizi.spesialisasi_valid


class MenuDiet:
    """Merepresentasikan sebuah menu diet yang disusun oleh ahli gizi."""
    ...
    def kalori(self, nilai_baru):
        """Setter kalori dengan validasi harus berupa angka positif."""
    ...
    @classmethod
    def dari_dict(cls, data):
        """Factory method: membuat objek MenuDiet dari dictionary."""
        return cls(
    ...
    def validasi_kalori(nilai):
        """Fungsi bantu untuk mengecek apakah nilai kalori valid (angka > 0)."""
        return isinstance(nilai, (int, float)) and nilai > 0


class CatatanKesehatan:
    """Mencatat riwayat pemeriksaan kesehatan seorang pasien pada tanggal tertentu."""
    ...
    def __init__(self, pasien, tanggal, berat_badan_tercatat, catatan_tambahan="-"):
        self.pasien = pasien  # objek Pasien -> bentuk interaksi antar-class
    ...
    def berat_badan_tercatat(self):
        """Getter berat badan yang tercatat pada kunjungan ini."""
        return self.__berat_badan_tercatat

    @berat_badan_tercatat.setter
    def berat_badan_tercatat(self, nilai_baru):
        """Setter berat badan tercatat dengan validasi harus lebih dari 0."""
        if nilai_baru <= 0:
    ...
    def tampilkan_catatan(self):
        """Menampilkan isi catatan kesehatan."""
    ...
    @classmethod
    def rekap_total(cls):
        """Menampilkan total seluruh catatan kesehatan yang pernah dibuat."""
    ...
    def validasi_format_tanggal(tanggal_str):
        """Fungsi bantu sederhana untuk mengecek format tanggal DD-MM-YYYY."""
        bagian = tanggal_str.split("-")
        return len(bagian) == 3 and all(b.isdigit() for b in bagian)


# =====================================================================
# MAIN CODE - Demonstrasi & Pengujian Program
# =====================================================================
if __name__ == "__main__":
    ...
    pasien2 = Pasien.dari_dict(data_pasien2)  # class method (factory)
    ...
    # ---------- 4. Uji Instance Method ----------
    print("\n[4] Uji Instance Method: hitung_kebutuhan_kalori()")
    pasien1.hitung_kebutuhan_kalori()   # kategori reguler
    pasien2.hitung_kebutuhan_kalori()   # kategori kondisi_medis

    atlet1 = Pasien("P003", "Andi", "andi111", 80, 180, "Tidak ada", "atlet")
    atlet1.hitung_kebutuhan_kalori()    # kategori atlet -> faktor berbeda
